...
使用sass启动项目时报错:Module build failed: Error: `sass-loader` requires `node-sass` >=4. Please install a compatible version.
解决:npm rebuild node-sass //用于更改包内容后重建

https://segmentfault.com/a/1190000014094732
...
const { getArgs } = require('axtool/tools.js');
const JAVA = require('./java.env.js');
const args = getArgs();
const JAVAENV = args.java || 'test';
